...
contract DSCEngineTest is Test {
    ...
    address public LIQUIDATIONUSER = makeAddr("liqudaitonUser");
    ...
    function testRevertsIfCollateralZero() public {
       ...
       // what is the selector doing here and what is it's purpose ?
    ...
    function testCanGetDepositCollateralAndGetAccountInfo() public depositedCollateral{
    ...
    function testDoesNotLiquidateUserIfHealthFactorOk() public depositedCollateral {
      vm.startPrank(USER);
